    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="子表数据添加">
        <div>
          ...
          <el-button type="primary" @click="dialogFormVisible = true">新增子表数据</el-button>
          <el-dialog title="业务子表数据" v-model="dialogFormVisible">
            <el-form :model="currentModel">
              <el-form-item label="日期">
                <el-date-picker
                  v-model="currentModel.date"
                  type="date"
                  placeholder="选择日期时间">
                </el-date-picker>
              </el-form-item>
              <el-form-item label="姓名">
                <el-input v-model="currentModel.name" placeholder="请输入内容"></el-input>
              </el-form-item>
              <el-form-item label="年龄">
                <el-input v-model="currentModel.age" placeholder="请输入内容"></el-input>
              </el-form-item>
            </el-form>
    ...
    methods: {
      ...
      handleAddData () {
        if (this.isFormEdit) {
          ...
          let addModel = Object.assign({}, this.currentModel)
          this.ruleForm.tableData.push(addModel)
          this.currentModel = {
            date: '',
            name: '',
            age: ''
